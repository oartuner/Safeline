...
import { Activity, Brain, Globe, ShieldCheck, BarChart, Zap, ArrowRight } from 'lucide-react';
...
const FeaturesSection = () => {
    ...
    const features = [
        {
            id: 1,
            title: t('services.0') || 'Road Freight', // Fallback if array access fails or i18n not ready
            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold mb-4 text-primary font-heading">
                        {t('about.values_title') || 'Comprehensive Solutions'}
                    </h2>
                    <p className="text-xl text-text-muted max-w-2xl mx-auto">
                        Discover our end-to-end logistics capabilities designed for efficiency and scale.
                    </p>
                </motion.div>
...
function FeatureCard({ feature, index }) {
    ...
    return (
        <motion.div
            ref={cardRef}
            className={`${feature.size} group relative bg-white rounded-3xl border border-border-light overflow-hidden cursor-pointer`}
