    ...
    <section id="home" className="relative min-h-[60vh] flex items-center pt-16 pb-20 overflow-hidden bg-white">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-6 sm:gap-12 pt-6 border-t border-border-light/40"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            transition={{ duration: 0.8, delay: 0.8 }}
          >
            <div className="text-center group cursor-default">
              <div className="text-3xl sm:text-5xl font-black text-primary font-heading group-hover:text-secondary transition-colors duration-300 flex justify-center items-center gap-1">
            ...
            <div className="hidden sm:block w-px h-16 bg-gradient-to-b from-transparent via-border-light to-transparent"></div>
            <div className="text-center group cursor-default">
              <div className="text-3xl sm:text-5xl font-black text-secondary font-heading group-hover:text-primary transition-colors duration-300 flex justify-center items-center gap-1">
